...
#ifdef WIFI_BT_USE_M2_INTERFACE
        /* Set SDIO_RST to 1 */
        //GPIO_PortSet(BOARD_INITWIFIPIN_SDIO_RST_GPIO, BOARD_INITWIFIPIN_SDIO_RST_PIN_MASK);
        //vTaskDelay(pdMS_TO_TICKS(100));

        /* Set WL_RST to 1 */
        GPIO_PortSet(BOARD_INITWIFIPIN_WL_RST_GPIO, BOARD_INITWIFIPIN_WL_RST_PIN_MASK);
        vTaskDelay(pdMS_TO_TICKS(100));
...
#ifdef WIFI_BT_USE_M2_INTERFACE
        /* Set WL_RST to 0 */
        GPIO_PortClear(BOARD_INITWIFIPIN_WL_RST_GPIO, BOARD_INITWIFIPIN_WL_RST_PIN_MASK);
        /* Set SDIO_RST to 0 */
        //GPIO_PortClear(BOARD_INITWIFIPIN_SDIO_RST_GPIO, BOARD_INITWIFIPIN_SDIO_RST_PIN_MASK);
#elif defined(WIFI_BT_USE_USD_INTERFACE)

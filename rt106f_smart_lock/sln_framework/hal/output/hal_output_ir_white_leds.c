...
static led_pwm_t s_LedPwms[2] = {[kLEDType_White] = {.baseAddr      = RGB_PWM_BASE_ADDR,
			                                         .submodule     = RGB_PWM_SUBMODULE,
			                                         .channel       = RGB_PWM_CHANNEL,
			                                         .controlModule = RGB_PWM_CTLMODULE,
			                                         .faultInput    = RGB_PWM_FAULTINPUT,
			                                         .faultChannel  = RGB_PWM_FAULTCHANNEL,
			                                         .faultDisable  = RGB_PWM_FAULTDISABLE},

		                         [kLEDType_Ir] = {.baseAddr      = IR_PWM_BASE_ADDR,
			                                      .submodule     = IR_PWM_SUBMODULE,
			                                      .channel       = IR_PWM_CHANNEL,
			                                      .controlModule = IR_PWM_CTLMODULE,
			                                      .faultInput    = IR_PWM_FAULTINPUT,
			                                      .faultChannel  = IR_PWM_FAULTCHANNEL,
			                                      .faultDisable  = IR_PWM_FAULTDISABLE}};
...
static int _init_led_pwm(led_type_t led)
{
    ...
    XBARA_Init(XBARA1);
    XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputLogicHigh, XBARA1_OUPUT_0);
    XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputLogicHigh, XBARA1_OUPUT_1);
    XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputLogicHigh, XBARA1_OUPUT_2);
    XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputLogicHigh, XBARA1_OUPUT_3);

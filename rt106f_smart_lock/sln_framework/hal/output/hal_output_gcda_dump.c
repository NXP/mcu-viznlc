...
#ifdef ENABLE_OUTPUT_DEV_GCDA_Dump
...
static hal_output_status_t gcda_dump_init(output_dev_t *dev, output_dev_callback_t callback)
{
...
#endif /* ENABLE_OUTPUT_DEV_GCDA_Dump */

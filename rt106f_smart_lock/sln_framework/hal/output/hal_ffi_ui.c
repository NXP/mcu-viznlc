 ...
 * Prototypes
 ******************************************************************************/
static hal_output_status_t HAL_OutputDev_UiFfi_Init(output_dev_t *dev, output_dev_callback_t callback);

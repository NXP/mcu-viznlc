...
#ifdef ENABLE_CAMERA_DEV_MipiOrbbecU1s
#include <FreeRTOS.h>
#include <stdlib.h>
#include <task.h>
...
static hal_camera_status_t HAL_CameraDev_MipiOrbbecU1s_Dequeue(const camera_dev_t *dev,
                                                               void **data,
...
#endif /* ENABLE_CAMERA_DEV_MipiOrbbecU1s */

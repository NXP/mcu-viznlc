...
#ifdef ENABLE_CAMERA_DEV_RGBSim
#include <FreeRTOS.h>
#include <task.h>
#include <stdlib.h>
#include <time.h>
...
static fwk_timer_t *s_VsyncTimer;
...
static hal_camera_status_t _CameraDevRGBSimInit(
...
static hal_camera_status_t _CameraDevRGBSimStart(const camera_dev_t *dev)
{
    ...
    if (FWK_Timer_Start("CameraDevRGBSim", CAMERA_VSYNC_TIME, 1, _CameraReceiverCallback, (void *)dev, &s_VsyncTimer))
    {
...
#endif /* ENABLE_CAMERA_DEV_RGBSim */

...
{
    .i2cSendFunc       = BOARD_CSICameraRGBI2CSend,
    .i2cReceiveFunc    = BOARD_CSICameraRGBI2CReceive,
    .pullResetPin      = pull_reset_pin,
    .pullPowerDownPin  = BOARD_PullCSICameraRGBPowerDownPin,
    .inputClockFreq_Hz = 24000000,
},
{
    .i2cSendFunc       = BOARD_CSICameraIRI2CSend,
    .i2cReceiveFunc    = BOARD_CSICameraIRI2CReceive,
    .pullResetPin      = pull_reset_pin,

...
static hal_camera_status_t HAL_CameraDev_3DSim_Start(const camera_dev_t *dev)
{
    ...
    status = FWK_Timer_Start("CameraDev3DSim", CAMERA_VSYNC_TIME, 1, HAL_CameraDev_3DSim_ReceiverCallback, (void *)dev,
                             &s_pVsyncTimer);

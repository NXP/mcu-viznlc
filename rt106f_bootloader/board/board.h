...
#define BOARD_USB_CLOCK_FREQ    (24000000U)
...
#define BOARD_CSI_RGB_CAMERA_I2C_BASE LPI2C4
#define BOARD_CSI_IR_CAMERA_I2C_BASE  LPI2C1
#define BOARD_CSI_RGB_CAMERA_PWDN_GPIO GPIO1
#define BOARD_CSI_RGB_CAMERA_PWDN_PIN  00U

#define BOARD_CSI_IR_CAMERA_PWDN_GPIO GPIO1
#define BOARD_CSI_IR_CAMERA_PWDN_PIN  01U

#else
#define BOARD_CSI_RGB_CAMERA_I2C_BASE LPI2C4
#define BOARD_CSI_IR_CAMERA_I2C_BASE LPI2C4
...
#if TARGET_BOARD == SLN_VIZNLC_IOT_BOARD
#define BOARD_BUTTON_SW1_GPIO GPIO3
#define BOARD_BUTTON_SW1_PIN (03U)
#define BOARD_BUTTON_SW2_GPIO GPIO3
#define BOARD_BUTTON_SW2_PIN (02U)
#define BOARD_BUTTON_SW1_IRQ GPIO3_Combined_0_15_IRQn
#define BOARD_BUTTON_SW2_IRQ GPIO3_Combined_0_15_IRQn
#else
...
#if TARGET_BOARD == SLN_VIZNLC_IOT_BOARD
#define LPSPI_CLOCK_SOURCE_ROOT kCLOCK_Root_Lpspi4
...
#define BOARD_ELCDIF_DISPLAY_SPI_BASE LPSPI4
#define BOARD_ELCDIF_DISPLAY_RESET_GPIO GPIO2
#define BOARD_ELCDIF_DISPLAY_RESET_PIN 20U
#define BOARD_ELCDIF_DISPLAY_BACKLIGHT_GPIO GPIO1
#define BOARD_ELCDIF_DISPLAY_BACKLIGHT_PIN 15U
...
#define BOARD_ELCDIF_DISPLAY_SPI_SCL_PIN 23U
#define BOARD_ELCDIF_DISPLAY_SPI_SDA_GPIO GPIO2
#define BOARD_ELCDIF_DISPLAY_SPI_SDA_PIN 22U
...
#define BOARD_BLE_K32W61_QN_WAKEUP_GPIO GPIO2
#define BOARD_BLE_K32W61_QN_WAKEUP_PIN 13U

#if TARGET_BOARD == SLN_VIZNLC_IOT_BOARD
#define BOARD_BLE_K32W61_RESET_GPIO GPIO2
#define BOARD_BLE_K32W61_RESET_GPIO_PIN 26UL
#endif

/* SAI instance and clock */
#define MQS_SAI SAI3
/* Select Audio/Video PLL (786.48 MHz) as sai3 clock source */
#define MQS_SAI3_CLOCK_SOURCE_SELECT (2U)
/* Clock pre divider for sai3 clock source */
#define MQS_SAI3_CLOCK_SOURCE_PRE_DIVIDER (1U)
/* Clock divider for sai3 clock source */
#define MQS_SAI3_CLOCK_SOURCE_DIVIDER (63U)

/* Get frequency of MQS sai3 clock */
#define MQS_SAI_CLK_FREQ                                                        \
    (CLOCK_GetFreq(kCLOCK_AudioPllClk) / (MQS_SAI3_CLOCK_SOURCE_DIVIDER + 1U) / \
     (MQS_SAI3_CLOCK_SOURCE_PRE_DIVIDER + 1U))

#define BOARD_MQS_OE_GPIO_PORT GPIO1
#define BOARD_MQS_OE_GPIO_PIN  0x08U

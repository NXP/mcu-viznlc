    ...
    .memConfig =
        {
		    ...
		    .csPadSettingOverride = 0x1090u,   //!< [0x060-0x063] CS pad setting override value
		    .sclkPadSettingOverride= 0x1090u, //!< [0x064-0x067] SCK pad setting override value
		    .dataPadSettingOverride = 0x1090u, //!< [0x068-0x06b] data pad setting override value
		    .dqsPadSettingOverride = 0x1090u,  //!< [0x06c-0x06f] DQS pad setting override value
